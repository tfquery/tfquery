...
cpoilot-instructions.md has other guidance that is relevant to go, which should be followed.
...
8. **Keep consistent comments**: Comments should always wrap at column 80. Always include just one space after a sentence ending character.

9. **Cyclomatic complexity**: When simplifying cyclomatic complexity lint issues, always favor guard statements and early exists as opposed to introduction of helper functions.
